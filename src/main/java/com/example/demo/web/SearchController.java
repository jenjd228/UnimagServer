...
public class SearchController {
    ...
    SearchController(HashMap<Integer, Category> allCategoriesMap,ModelMapper modelMapperCatalogToProduct,CatalogService catalogService, CatalogRepository catalogRepository){
