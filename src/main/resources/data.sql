...
(1,'hashe4gerge4','Souvenirs',1612656411,'Красивый блокнот - залог успеха любого студента. А если он выполнен еще и в деревянном стиле - то тогда друзья точно оценят Ваш вкус. Задумайтесь над этим','https://docs.google.com/uc?id=1DTJvR7GrZziGlgsB1sPcvzMDjReosXsj',500,'Блокнот ЮФУ с деревянной обложкой'),
(2,'hashe4gerge5','Clothes',1612656411,'Вы мечтали когда-нибудь об универсальной одежде, в которой можно выйти и в город, и в университет? Тогда это теплое синее худи точно осуществит вашу мечту! Сшитое из специальных тканей, оно будет легко прилегать к вашему телу, не досталяя ни малейшего дискомфорта. А универсальный дизайн точно выделит вас среди других студентов. Успейтие приобрести!','https://docs.google.com/uc?id=1XA_04gUUX2F_MGFwCSiuj07gffw5hAMd',1600,'Синее худи'),
(3,'hashe4gergef','Souvenirs',1612656411,'Магнитик на холодильнике - это часто кусочек истории вашей жизни, глядя на который погружаешься в теплые воспоминания. Так подарите себе и своим близким такые незабываемые воспоминания!','https://docs.google.com/uc?id=1yBfjOmEanPhJ6VrcEOzCjbfw0q8Cp2YN',200,'Магнит с главным корпусом'),
(4,'hashe4getge5','Clothes',1612656411,'Этот лонгслив будет смотреться прекрасно везде, где бы Вы не находились: на лекциях в университете, на соревнованиях по дартсу или же просто на улице. Приобретая такой лонгслив, Вы приобретает не просто элемент одежды в свой гардероб -  Вы приобретаете уникальную возможность выделить себя в толпе студентов!','https://docs.google.com/uc?id=1Eildzzx7aPAOog_LbxurjibeOXcUsPlJ',1200,'Черный лонгслив'),
(5,'hasss4gerge5','Souvenirs',1612656411,'Что может быть лучше запаха кофе по утрам? Только запах кофе из кружки с логотипом Южного Федерального Университета! Не упустите возможность встретить следующее утро в объятях новой атмосферы, создаваемой данной кружкой!','https://docs.google.com/uc?id=1KTfJMxTB5k32cQivlSsa0sNiZo56qY37',600,'Красная кружка с логотипом ЮФУ'),
(6,'has34rhe4gerge4','Souvenirs',1612656411,'Красивый блокнот - залог успеха любого студента. А если он выполнен еще и в деревянном стиле - то тогда друзья точно оценят Ваш вкус. Задумайтесь над этим','https://docs.google.com/uc?id=1DTJvR7GrZziGlgsB1sPcvzMDjReosXsj',500,'Блокнот ЮФУ с деревянной обложкой'),
(7,'hasrgbhe4gerge5','Clothes',1612656411,'Вы мечтали когда-нибудь об универсальной одежде, в которой можно выйти и в город, и в университет? Тогда это теплое синее худи точно осуществит вашу мечту! Сшитое из специальных тканей, оно будет легко прилегать к вашему телу, не досталяя ни малейшего дискомфорта. А универсальный дизайн точно выделит вас среди других студентов. Успейтие приобрести!','https://docs.google.com/uc?id=1XA_04gUUX2F_MGFwCSiuj07gffw5hAMd',1600,'Синее худи'),
(8,'has32he4gergef','Souvenirs',1612656411,'Магнитик на холодильнике - это часто кусочек истории вашей жизни, глядя на который погружаешься в теплые воспоминания. Так подарите себе и своим близким такые незабываемые воспоминания!','https://docs.google.com/uc?id=1yBfjOmEanPhJ6VrcEOzCjbfw0q8Cp2YN',200,'Магнит с главным корпусом'),
(9,'has34566he4getge5','Clothes',1612656411,'Этот лонгслив будет смотреться прекрасно везде, где бы Вы не находились: на лекциях в университете, на соревнованиях по дартсу или же просто на улице. Приобретая такой лонгслив, Вы приобретает не просто элемент одежды в свой гардероб -  Вы приобретаете уникальную возможность выделить себя в толпе студентов!','https://docs.google.com/uc?id=1Eildzzx7aPAOog_LbxurjibeOXcUsPlJ',1200,'Черный лонгслив'),
(10,'has432221ss4gerge5','Souvenirs',1612656411,'Что может быть лучше запаха кофе по утрам? Только запах кофе из кружки с логотипом Южного Федерального Университета! Не упустите возможность встретить следующее утро в объятях новой атмосферы, создаваемой данной кружкой!','https://docs.google.com/uc?id=1KTfJMxTB5k32cQivlSsa0sNiZo56qY37',600,'Красная кружка с логотипом ЮФУ');
...
(6,'https://docs.google.com/uc?id=1DTJvR7GrZziGlgsB1sPcvzMDjReosXsj'),
(6,'https://docs.google.com/uc?id=1-wpe2iCO7Cpnizig7VJQrzp-fmBOgknJ'),
(6,'https://docs.google.com/uc?id=1K8bEFZHlRV52mhCdDVTwLv3E6hgeR5M1'),
(6,'https://docs.google.com/uc?id=1IygGGMVALl1r2cBqPH_zzfitlo7jH_d6'),
(7,'https://docs.google.com/uc?id=1XA_04gUUX2F_MGFwCSiuj07gffw5hAMd'),
(7,'https://docs.google.com/uc?id=1S0Yel35eItz3pYrQKj8h9nxZHvvWzy68'),
(7,'https://docs.google.com/uc?id=1eAnF1so0NQW6CwWiJ_t7kehU8YCWhl45'),
(8,'https://docs.google.com/uc?id=1yBfjOmEanPhJ6VrcEOzCjbfw0q8Cp2YN'),
(8,'https://docs.google.com/uc?id=1IfXMzbHM1zVnKOTMjBVdVzC89-dQ_gLZ'),
(8,'https://docs.google.com/uc?id=1hUSjh_Y9WyErY7RRPXZ4HQTKHqQ-mjlZ'),
(9,'https://docs.google.com/uc?id=1Eildzzx7aPAOog_LbxurjibeOXcUsPlJ'),
(9,'https://docs.google.com/uc?id=1R53pDPIgEZxGIrNJ-WOOOl3uElaUQkLB'),
(9,'https://docs.google.com/uc?id=1BvhdDpUTrgLIOUm01FqJJwvEouViHJLl'),
(10,'https://docs.google.com/uc?id=1KTfJMxTB5k32cQivlSsa0sNiZo56qY37'),
(10,'https://docs.google.com/uc?id=1MR8CXxehdtzKuTnNJx4E3zOK_eh03d_6'),
(10,'https://docs.google.com/uc?id=1lJKHqCaXKyiiHaAPg3ZbThlIXaUK0Ifr');